...
void main() {
  group('Two Darts Game Widget Tests', () {
    ...
    testWidgets('Complete Two Darts game workflow - target progression', (WidgetTester tester) async {
      ...
      await tester.pumpAndSettle();
      controller.pressNumpadButton(0); // 10th target - failure
      await tester.pumpAndSettle();
    ...
    testWidgets('Two Darts undo functionality test', (WidgetTester tester) async {
      ...
      await tester.pump();
      controller.pressNumpadButton(1); // Success on target 2
      await tester.pump();
    ...
    testWidgets('Two Darts invalid input handling', (WidgetTester tester) async {
      ...
      await tester.pump();
      controller.pressNumpadButton(-3); // Invalid
      await tester.pump();
      controller.pressNumpadButton(10); // Invalid
      await tester.pump();
      ...
      controller.pressNumpadButton(1); // Valid success
      await tester.pump();
      controller.pressNumpadButton(0); // Valid failure
      await tester.pump();
