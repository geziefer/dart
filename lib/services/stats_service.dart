...
class StatsService {
  ...
  void updateRecord<T extends Comparable>(String key, T newValue,
  ...
  void updateRecordWithCondition<T>(String key, T newValue,
      bool Function(T current, T newValue) shouldUpdate) {
  ...
  void updateLongTermAverage(String key, double newValue) {
    int newGameCount =
        _storageService.read<int>('numberGames', defaultValue: 0)!;
    double currentAverage =
        _storageService.read<double>(key, defaultValue: 0.0)!;
