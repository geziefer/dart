                ...
                Expanded(
                  ...
                  child: Row(
                    ...
                    children: [
                      for (int i = 7; i <= 9; i++)
                        _buildNumpadButton(
                            context, controller, i.toString(), i),
                    ],
                  ),
                ),
              if (showMiddle)
          ...
          children: [
            Expanded(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  _buildNumpadButton(context, controller, '26', 26),
                  _buildNumpadButton(context, controller, '41', 41),
                  _buildNumpadButton(context, controller, '45', 45),
                  _buildNumpadButton(context, controller, '55', 55),
                  _buildNumpadButton(context, controller, '60', 60),
                ],
              ),
            ),
            Expanded(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  _buildNumpadButton(context, controller, '81', 81),
                  _buildNumpadButton(context, controller, '85', 85),
                  _buildNumpadButton(context, controller, '100', 100),
                  _buildNumpadButton(context, controller, '140', 140),
                  _buildNumpadButton(context, controller, '180', 180),
                ],
              ),
            ),
          ],
